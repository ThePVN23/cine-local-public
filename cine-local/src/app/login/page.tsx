  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        localStorage.setItem("cineLocalUser", JSON.stringify(data.user));
      }
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#000" }}>
      ...
      <div style={{ maxWidth: "28rem", margin: "0 auto", padding: "5rem 2rem" }}>
        <div style={{ backgroundColor: "#111827", borderRadius: "0.5rem", padding: "2rem" }}>
          ...
          {error && (
            <div style={{ backgroundColor: "rgba(220, 38, 38, 0.2)", color: "#fca5a5", padding: "0.75rem", borderRadius: "0.375rem", marginBottom: "1rem", textAlign: "center" }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} style={{ display: "grid", gap: "1rem" }}>
            <div style={{ display: "grid", gap: "0.5rem" }}>
              ...
              <input
                ...
                style={{ padding: "0.75rem", borderRadius: "0.375rem", border: "1px solid #374151", backgroundColor: "#1f2937", color: "white" }}
                value={email}
          ...
          <p style={{ color: "#9ca3af", marginTop: "1rem", textAlign: "center" }}>
            ...
            <Link href="/signup" style={{ color: "#DC2626" }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
